...
import lib.ruijia.zbar.qrcodecore.ScanResult;
import lib.ruijia.zbar.qrodecontinue.ContinueQRCodeView;
import lib.ruijia.zbar.qrodecontinue.ContinueScanResult;

public class ZBarContinueView extends ContinueQRCodeView {
    ...
    public ZBarContinueView(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public ZBarContinueView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        Log.e("SJY", "ZBarContinueView--xml初始化");
        setupReader();
    }
    ...
    public ContinueScanResult processData(byte[] data, int width, int height, boolean isRetry) {
        ...
        return new ContinueScanResult(result);
    }
    ...
    @Override
    protected ContinueScanResult processBitmapData(Bitmap bitmap) {
        try {
