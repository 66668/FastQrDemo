...
final class ContinueCameraConfigurationManager {
    ...
    ContinueCameraConfigurationManager(Context context) {
        mContext = context;
    }

    void initFromCameraParameters(Camera camera) {
        Point screenResolution = ContinueBGAQRCodeUtil.getScreenResolution(mContext);
        Point screenResolutionForCamera = new Point();
        screenResolutionForCamera.x = screenResolution.x;
        screenResolutionForCamera.y = screenResolution.y;

        if (ContinueBGAQRCodeUtil.isPortrait(mContext)) {
