...
import lib.ruijia.zxing.control.InactivityTimer;
import lib.ruijia.zxing.control.Intents;
...
public class CaptureManager {
    ...
    protected void displayFrameworkBugMessageAndExit() {
        ...
        builder.setTitle(activity.getString(R.string.app_name));//zxing_app_name
