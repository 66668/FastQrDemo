...
import lib.ruijia.zxing.R;
import lib.ruijia.zxing.scan.camera.CameraInstance;
import lib.ruijia.zxing.scan.camera.CameraParametersCallback;
import lib.ruijia.zxing.scan.camera.CameraSettings;
import lib.ruijia.zxing.scan.camera.CameraSurface;
import lib.ruijia.zxing.scan.camera.CenterCropStrategy;
import lib.ruijia.zxing.scan.camera.DisplayConfiguration;
import lib.ruijia.zxing.scan.camera.FitCenterStrategy;
import lib.ruijia.zxing.scan.camera.FitXYStrategy;
import lib.ruijia.zxing.scan.camera.PreviewScalingStrategy;
