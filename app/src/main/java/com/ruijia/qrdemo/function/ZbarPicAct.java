 ...
 */
public class ZbarPicAct extends AppCompatActivity implements View.OnClickListener, ContinueQRCodeView.Delegate {
    ...
    private String picType;//jpg，png
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.btn_select:
                ...
                picker.setAllowExtensions(new String[]{".jpg", ".png"});
        ...
        new AsyncTask<Void, Void, Bitmap>() {
            ...
            protected void onPostExecute(Bitmap bitmap) {
                if (bitmap != null) {
                    ...
                    Log.e("SJY", "生成英文二维码失败");
                    Toast.makeText(ZbarPicAct.this, "生成英文二维码失败", Toast.LENGTH_SHORT).show();
                }
            }
        }.execute();
    }
    ...
    private void saveFile() {
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                ...
                return IOUtils.base64ToFile(data, "jpg");
            }
    ...
    private void initData(final File file) {
        ...
        new AsyncTask<Void, Void, String>() {
            ...
            protected String doInBackground(Void... voids) {
                try {
                    //File转String
                    String data = IOUtils.pngFile2String(file);
            ...
            protected void onPostExecute(String s) {
                if (s != null) {
                    Log.e("SJY", s);
                    Toast.makeText(ZbarPicAct.this, s, Toast.LENGTH_SHORT).show();
                    btn_show.setVisibility(View.GONE);
                    return;
                }
