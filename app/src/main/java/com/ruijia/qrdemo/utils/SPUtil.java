...
import com.ruijia.qrdemo.QrApplication;
...
public class SPUtil {
    //文件名
    private static final String CONFIG = "qr_constants";
    ...
    private static SharedPreferences getSharedPreference(String fileName) {
        return QrApplication.getInstance().getSharedPreferences(fileName, Context.MODE_PRIVATE);
    }
